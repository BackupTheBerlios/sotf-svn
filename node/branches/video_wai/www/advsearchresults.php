...
/*  
 * $Id: advsearchresults.php 558 2006-05-04 14:34:58Z buddhafly $
...
{
   ///////// not necessary in the new xhtml-templates affirmed by Klaus Temper /////////////////////////////////////
...
/////////////// added by Klaus Temper instead of the above//////////////////////////////////// 
  foreach($result[$i] as $key => $value) {
	 if ($key != 'title') {		//title is presented on a diferent level
...
//////////////////////////////////////////////////////////////////////////////
  ...
  if (array_key_exists("person", $fields))		//person is a special filed
	...
	foreach($values as $k => $v) //added by Klaus Temper
		{
			$newvalues[strtolower(str_replace(" ","_",$k))] = $v;
