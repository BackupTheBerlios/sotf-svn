...
/*  
 * $Id: editor.php 577 2006-05-29 12:04:06Z buddhafly $
...
if(!empty($stations)) {
  $smarty->assign_by_ref("STATIONS_EDITOR",$stations);		// changed STATIONS to STATIONS_EDITOR due to smarty variable conflict with variable in loadvars.inc.php. mh061123
}
...
$myProgs = sotf_Programme::myProgrammes($series, $filter, $sort1." DESC, ".$sort2.$limit["limit"]);  //DESC added by Klaus Temper
