...
/*  
 * $Id: init.inc.php 558 2006-05-04 14:34:58Z buddhafly $
...
$smarty = new Smarty;
$smarty->template_dir = $config['basedir'] . "/code/templates_xhtml";
$smarty->compile_dir = $config['basedir'] . "/code/templates_c_xhtml";
...
// load smarty variables for page display - mh
require("loadvars.inc.php");
