...
/*
 ...
 Version 1.5.10, 2005-05-20, http://alexandre.alapetite.net/doc-alex/domxml-php4-php5/
...
class php4DOMNode
{
 ...
 function replace_child($oldnode,$newnode) {return new php4DOMElement($this->myDOMNode->replaceChild($oldnode->myDOMNode,$this->_importNode($newnode)),$this->myOwnerDocument);}
