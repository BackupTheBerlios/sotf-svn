	...
	****************/
	class dayView{
		...
		var $content = "<table cellspacing=0 cellpadding=0 border=0>
                ...
                <td bgcolor={color_on}>{content_owner}<font size=-1><a href=\"showprogrammedetails.php?id={content_id}\" onclick=\"NewWindow(this.href,'14','620','460','yes');return false\">{content_name}</a></font>&nbsp;{special}&nbsp;<font size=-1 color={color_text}>({content_start_time}-{content_end_time})</font></td></tr></tbody></table>";
